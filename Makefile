# This Makefile is for the Acme::CPANAuthors::Russian extension to perl.
#
...
#     EXE_FILES => []
#     INSTALLDIRS => q[site]
#     NAME => q[Acme::CPANAuthors::Russian]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Acme::CPANAuthors=>q[0], Acme::CPANAuthors::Register=>q[0] }
#     VERSION_FROM => q[lib/Acme/CPANAuthors/Russian.pm]
...
NAME_SYM = Acme_CPANAuthors_Russian
VERSION = 1.01
...
MAKE = make
FULLEXT = Acme/CPANAuthors/Russian
BASEEXT = Russian
PARENT_NAME = Acme::CPANAuthors
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Acme/CPANAuthors/Russian.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Acme/CPANAuthors
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Acme/CPANAuthors
...
PM_TO_BLIB = lib/Acme/.DS_Store \
	blib/lib/Acme/.DS_Store \
	lib/.DS_Store \
	blib/lib/.DS_Store \
	lib/Acme/CPANAuthors/Russian.pm \
	blib/lib/Acme/CPANAuthors/Russian.pm
...
DISTNAME = Acme-CPANAuthors-Russian
DISTVNAME = Acme-CPANAuthors-Russian-1.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Acme/CPANAuthors/Russian.pm $(INST_MAN3DIR)/Acme::CPANAuthors::Russian.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                Acme-CPANAuthors-Russian' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Acme::CPANAuthors:             0' >> META_new.yml
	$(NOECHO) $(ECHO) '    Acme::CPANAuthors::Register:   0' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Acme-CPANAuthors" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Acme-CPANAuthors-Register" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Acme/.DS_Store blib/lib/Acme/.DS_Store \
	  lib/.DS_Store blib/lib/.DS_Store \
	  lib/Acme/CPANAuthors/Russian.pm blib/lib/Acme/CPANAuthors/Russian.pm 
